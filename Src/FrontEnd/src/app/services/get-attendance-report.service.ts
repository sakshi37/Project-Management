...
export class GetAttendanceReportService {
  ...
  getEARByDivisionName(
    divisionName: string
  ): Observable<GetAttendanceReportDtoService[]> {
    return this.http.get<GetAttendanceReportDtoService[]>(
      `${this.apiUrl}/DivisionName?divisionName=${divisionName}`
    );
  }
  getEAREmployeeName(
    employeeName: string
    ...
    return this.http.get<GetAttendanceReportDtoService[]>(
      `${this.apiUrl}/EmployeeName?employeeName=${employeeName}`
    );
  }
  getEARByTLName(
    employeeId: number
